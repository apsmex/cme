...
function crece() {
    ...
    var plazoCrece = document.getElementById('plazoCrece').value;
    var montoCrece = document.getElementById('montoCrece').value;
    ...
    if (montoCrece.length == 0) {
        premio.remove();
        premioTexto.remove();
        errorTexto.remove();
    }

    switch (parseInt(plazoCrece)) {
    case 30: // 1 mes
        if (montoCrece < 100) {
            var recibeInteres = 0;
            var tasaRedondeada = 0;
            errorTexto.innerText = ErrorLeyenda;
        } else if (montoCrece >= 100 && montoCrece <= 1000) {
            var recibeInteres = (montoCrece * (tasas[2] / 360) * 30) + parseInt(montoCrece);
            var tasaRedondeada = Math.round(tasas[2] * 100);
        } else if (montoCrece >= 1001 && montoCrece <= 10000) {
            var recibeInteres = (montoCrece * (tasas[0] / 360) * 30) + parseInt(montoCrece);
            var tasaRedondeada = Math.round(tasas[0] * 100);
        } else if (montoCrece >= 10001) {
            var recibeInteres = (montoCrece * (tasas[0] / 360) * 30) + parseInt(montoCrece);
            var tasaRedondeada = Math.round(tasas[0] * 100);
        }
        break;
    ...
    case 90: // 3 meses
        if (montoCrece < 100) {
            ...
            var recibeInteres = (montoCrece * (tasas[0] / 360) * 90) + parseInt(montoCrece);
            var tasaRedondeada = Math.round(tasas[0] * 100);
        } else if (montoCrece >= 1001 && montoCrece <= 10000) {
            var recibeInteres = (montoCrece * (tasas[3] / 360) * 90) + parseInt(montoCrece);
            var tasaRedondeada = Math.round(tasas[3] * 100);
        } else if (montoCrece >= 10001) {
            var recibeInteres = (montoCrece * (tasas[5] / 360) * 90) + parseInt(montoCrece);
    ...
    case 180: // 6 meses
        if (montoCrece < 100) {
            ...
            var recibeInteres = (montoCrece * (tasas[0] / 360) * 180) + parseInt(montoCrece);
            var tasaRedondeada = Math.round(tasas[0] * 100);
        } else if (montoCrece >= 1001 && montoCrece <= 10000) {
            var recibeInteres = (montoCrece * (tasas[5] / 360) * 180) + parseInt(montoCrece);
            var tasaRedondeada = Math.round(tasas[5] * 100);
        } else if (montoCrece >= 10001) {
            var recibeInteres = (montoCrece * (tasas[7] / 360) * 180) + parseInt(montoCrece);
    ...
    case 360: // 12 meses
        if (montoCrece < 100) {
            ...
            var recibeInteres = (montoCrece * (tasas[1] / 360) * 360) + parseInt(montoCrece);
            var tasaRedondeada = Math.round(tasas[1] * 100);
        } else if (montoCrece >= 1001 && montoCrece <= 10000) {
            var recibeInteres = (montoCrece * (tasas[6] / 360) * 360) + parseInt(montoCrece);
            var tasaRedondeada = Math.round(tasas[6] * 100);
        } else if (montoCrece >= 10001) {
            var recibeInteres = (montoCrece * (tasas[8] / 360) * 360) + parseInt(montoCrece);
    ...
    case 540: // 18 meses
        if (montoCrece < 100) {
            ...
            var recibeInteres = (montoCrece * (tasas[1] / 360) * 540) + parseInt(montoCrece);
            var tasaRedondeada = Math.round(tasas[1] * 100);
        } else if (montoCrece >= 1001 && montoCrece <= 10000) {
            var recibeInteres = (montoCrece * (tasas[6] / 360) * 540) + parseInt(montoCrece);
            var tasaRedondeada = Math.round(tasas[6] * 100);
        } else if (montoCrece >= 10001) {
            var recibeInteres = (montoCrece * (tasas[8] / 360) * 540) + parseInt(montoCrece);
            var tasaRedondeada = Math.round(tasas[8] * 100);
            // Imagenes y texto del premio
            // premioTexto.innerText = PremioLeyenda;
            // premio.src = premiosImg[1];
    ...
    case 720: // 24 meses
        if (montoCrece < 100) {
            ...
            var recibeInteres = (montoCrece * (tasas[1] / 360) * 720) + parseInt(montoCrece);
            var tasaRedondeada = Math.round(tasas[1] * 100);
        } else if (montoCrece >= 1001 && montoCrece <= 10000) {
            var recibeInteres = (montoCrece * (tasas[6] / 360) * 720) + parseInt(montoCrece);
            var tasaRedondeada = Math.round(tasas[6] * 100);
        } else if (montoCrece >= 10001) {
            var recibeInteres = (montoCrece * (tasas[8] / 360) * 720) + parseInt(montoCrece);
            var tasaRedondeada = Math.round(tasas[8] * 100);
            // Imagenes y texto del premio
            // premioTexto.innerText = PremioLeyenda;
            // premio.src = premiosImg[1];
    ...
    var plazosReducido = (plazoCrece / 30);
    ...
    document.getElementById("plazoCreceMas").innerHTML = plazosReducido + " " + "Meses";
}
