(function(e) {
    e.extend(e.fn, {
        ...
        messages: {
            ...
            maxlength: e.validator.format("Introduce no más de {0} caracteres."),
            minlength: e.validator.format("El Ingreso Mensual debe ser mayor a $1,000"),
            rangelength: e.validator.format("Introduce un valor entre {0} y {1} caracteres de longitud."),
            range: e.validator.format("Introduce un valor entre {0} y {1}."),
            max: e.validator.format("Introduce un valor inferior o igual a {0}."),
            min: e.validator.format("Introduce un valor superior o igual a {0}.")
        },
        autoCreateRanges: !1,
        prototype: {
            init: function() {
        ...
        addMethod: function(t, n, r) {
            e.validator.methods[t] = n, e.validator.messages[t] = r !== undefined ? r : e.validator.messages[t], 
        ...
        methods: {
            ...
            remote: function(t, n, r) {
                ...
                this.settings.messages[n.name] || (this.settings.messages[n.name] = {}), i.originalMessage = this.settings.messages[n.name].remote, 
                this.settings.messages[n.name].remote = i.message, r = typeof r == "string" && {
                    url: r
                } || r;
