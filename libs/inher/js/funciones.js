...
/*************************************************************/
     ...
     $(function(){
     $('#formularioPrincipal').bind('submit', function(e){
        e.preventDefault();
     ...
     $(function(){
     $('#formularioCotizador').bind('submit', function(e){
        e.preventDefault();
        var formulario = $(this).attr('id');
        mensaje('');
        if(obligatoriosFaltantes(formulario)){
     ...
     // FORMULARIO IP TECHREO

    $(function(){
     $('#formularioPrincipalIP').bind('submit', function(e){
        e.preventDefault();
        var formulario = $(this).attr('id');
        mensaje('');
        if(obligatoriosFaltantes(formulario)){
